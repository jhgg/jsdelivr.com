...
<p>
jsDelivr is a public open-source CDN where anyone can submit a project to be hosted and delivered by our network. Most people probably know that Google hosts jQuery and a few other popular libraries.</p>
<p>
We don’t look at the popularity of the project to approve it for inclusion in jsDelivr. Plus a lot more types of projects are allowed, like CSS frameworks, fonts, WordPress plugins etc.</p>
<p>
...
<ul><li> Hosting companies that resell major CDN providers</li>
 ...
 <li>POPs - Min Requirements: 5GB HDD, 1TB Bandwidth, 512MB RAM, 2 cores CPU, CentOS x64</li>
     <ul> <li>    VPS servers with good network speed and uptime. Any location will do.</li>
     ...
     <li>     All POP locations will be used to serve static content. Nginx+SSL will be installed. We do not expect big CPU loads.</li>
      <li>    The traffic is load balanced by intelligent software that will monitor all POPs for performance and uptime.</li></ul>
